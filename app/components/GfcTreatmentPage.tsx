    ...
    <main className="bg-white text-textDark">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-textDark text-lg leading-relaxed">
              GFC (Growth Factor Concentrate) is a highly advanced and effective
              treatment for hair fall, thinning hair and weak hair follicles. It
              is the upgraded version of PRP and delivers superior results.
            </p>

            <p className="text-textDark text-lg leading-relaxed">
              At <strong>Pt. Yadram Skin Clinic</strong>,
              <strong> Dr. Koshinder Vats (MBBS, MD)</strong> uses certified GFC
              kits that extract **pure growth factors**, ensuring faster, safer
              and more visible hair regrowth.
            </p>
        ...
        <div className="mt-20">
          ...
          <ul className="space-y-3 text-lg leading-relaxed text-textDark">
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Blood is processed
              using a certified GFC kit
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Growth factors are
              extracted in pure form
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> GFC is injected into
              the scalp
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Stimulates hair
              follicles for regrowth
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Promotes stronger &
        ...
        <div className="mt-20">
          ...
          <ul className="space-y-3 text-lg text-textDark">
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> GFC contains pure
              growth factors (PRP contains blood plasma)
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Better results with
              fewer sessions
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> No pain, no swelling,
              quick recovery
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Ideal for both men &
              women
            </li>
          </ul>
        </div>
        ...
        <div className="mt-20">
          ...
          <ul className="space-y-3 text-lg text-textDark">
            ...
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> 4 sessions recommended
            </li>
            <li className="flex gap-2">
              <FaCheckCircle className="text-primary" /> Maintenance session
              every 6 months
            </li>
          </ul>
        </div>
