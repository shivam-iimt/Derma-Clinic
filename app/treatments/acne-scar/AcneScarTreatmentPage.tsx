        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-textDark text-lg leading-relaxed">
              ...
              they can be greatly reduced. At{" "}
              <strong>Pt. Yadram Skin Clinic</strong>,
              <strong> Dr. Koshinder Vats (MBBS, MD)</strong> treats all types
              of acne scars using microneedling, lasers, PRP, GFC, and chemical
              peels.
            </p>
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-lg leading-relaxed">
            <div className="space-y-3">
              {["Ice pick scars", "Boxcar scars", "Rolling scars"].map(
                (item, idx) => (
